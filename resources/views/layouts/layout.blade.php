...
<head>
    ...
    @yield('head')
    <title>@yield('title') - Yangon Air - Air Quality Of Yangon</title>
</head>
<body>
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        <a class="navbar-brand margin-logo" href="/"><img src="images/logo.png" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse nav-font" id="navbarSupportedContent">
          <ul class="navbar-nav m-auto padding-nav">
            ...
            <li class="nav-item {{ Request::is('lists') ? 'active' : '' }}">
                <a class="nav-link" href="/lists">AQIs Lists</a>
            </li>
